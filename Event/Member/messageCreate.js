    ...
    async execute(message, client, Discord) {
       ...
       if (command.permissions) {
          ...
          if (!authorPerms || !authorPerms.has(command.permissions)) {
             ...
             .setColor('RED')
             .setDescription('You do not have required to run this command')
      ...
      if (timestamps.has(message.author.id)) {
         ...
         if (now < expirationTime) {
            ...
            .setColor('RED')
            .setDescription(`please wait another ${timeLeft.toFixed(1)} more second to be able to run this command again`)
